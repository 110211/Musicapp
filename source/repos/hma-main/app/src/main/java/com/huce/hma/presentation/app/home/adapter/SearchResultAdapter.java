    ...
    public class SearchResultAdapter extends ArrayAdapter<SongSearchResultDTO> {

        Context context;
        ArrayList<SongSearchResultDTO> arrayList;
        int layoutResource;
        //Hàm khởi tạo cho CustomArrayAdapter
        public SearchResultAdapter(Context context, int resource, ArrayList<SongSearchResultDTO> objects) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView txt2 = (TextView)convertView.findViewById(R.id.tv_songArtist);
