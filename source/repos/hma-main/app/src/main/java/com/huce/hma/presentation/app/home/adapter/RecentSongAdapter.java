...
public class RecentSongAdapter extends ArrayAdapter<SongSearchResultDTO> {
    Context context;
    ArrayList<SongSearchResultDTO> arrayList;
    int layoutResource;
    //Hàm khởi tạo cho CustomArrayAdapter
    public RecentSongAdapter(Context context, int resource, ArrayList<SongSearchResultDTO> objects) {
